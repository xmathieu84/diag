...
/**
 * @ORM\Entity(repositoryClass=MaitresDOeuvreEnBatimentRepository::class)
 */
class MaitresDOeuvreEnBatiment
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    public function setFormJuridique(?string $formJuridique): self
    {
