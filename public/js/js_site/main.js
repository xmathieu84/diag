...
(function ($) {
    ...
    function initGoogleMap() {
        ...
        if ($googleMaps.length) {
            $googleMaps.each(function () {
                ...
                //map settings
                var address = $markers.first().find('.marker-address').text() ? $markers.first().find('.marker-address').text() : 'Pays, baker street, 221b';
    ...
    function documentReadyInit() {
        ...
        $(".bg_teaser, .cover-image").each(function () {
            ...
            //if image inside link - adding this link, removing gallery to preserve duplicating Galleries
            if ($imageParent.is('a')) {
        ...
        /////////////////////////////////////////////////
        //PHP widgets - Contactez-nous, search, MailChimp//
        /////////////////////////////////////////////////
        ...
        //search form En attente - not need in WP
        ...
        //MailChimp subscribe form En attente
        $('.signup').on('submit', function (e) {
            e.preventDefault();
            var $form = $(this);
            // update user interface
            $form.find('.response').html('Adding Email...');
